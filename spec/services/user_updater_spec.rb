  ...
  describe '#update' do
    ...
    context 'when skip_new_user_tips is edited' do
      it 'updates all fields' do
        ...
        expect(user.user_option.skip_first_notification).to eq(true)
        expect(user.user_option.skip_topic_timeline).to eq(true)
        ...
        expect(user.user_option.skip_first_notification).to eq(false)
        expect(user.user_option.skip_topic_timeline).to eq(false)
      end
    end
